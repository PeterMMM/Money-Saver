    ...
    <div>
      <div class="card-header">
        <ul class="nav nav-pills card-header-pills">
          ...
          <li class="nav-item">
            <router-link class="nav-link" to="/goals" >Goals
            </router-link>
          </li>
          <li class="nav-item">
            <router-link class="nav-link" to="/records" >Records
            </router-link>
          </li>
          ...
          <li class="nav-item" v-if="login">
            <a class="nav-link text-primary" style="cursor: pointer;"  v-on:click="logout()">
                Logout
            </a>
          </li>
        </ul>
            <router-link class="btn btn-sm btn-success" to="/goals/create" >
                Add Goal
            ...
            <router-link class="btn btn-sm btn-warning" to="/records/create" >
                Add Cash
